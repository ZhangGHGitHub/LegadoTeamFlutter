...
## 架构总览
下图展示从源码到产物的端到端构建链路，包括Android、Flutter、Rust与Web的交互关系。
...
## 结论
Legado项目通过Gradle、Flutter、Rust与Vite的组合，实现了跨平台应用的统一构建与持续交付。借助GitHub Actions与Dependabot，团队能够自动化测试、构建与发布，保证质量与效率。遵循本文档的环境搭建、构建流程、依赖管理与发布规范，可有效提升团队协作与交付稳定性。
