...
- ✅ **v1.30（2026-08-13）离线缓存导出扩展销记（v2.0.41）**：OfflineCacheScreen 单本导出改接 ExportDialog + `bookExportWithOptions`（txt/epub/pdf/html、charset、文件名模板 `{name}/{author}`、章节范围、导出进度、WebDAV 二进制上传）；原「仅拼 TXT 分享」路径退役。
