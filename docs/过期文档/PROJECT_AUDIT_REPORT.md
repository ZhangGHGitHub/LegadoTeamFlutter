> **历史注记（2026-08-22，P2-5）**：本文「零 todo!()/unimplemented!() 桩 / 无桩实现」等绝对表述已被废止——现行四分类可核查口径见 [docs/STUB_FALLBACK_CLASSIFICATION_2026-08-22.md](../STUB_FALLBACK_CLASSIFICATION_2026-08-22.md)；当前状态以 REFACTORING_ACTIVE_PLAN 为准。
