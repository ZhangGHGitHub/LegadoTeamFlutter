...
| R2① FastScroll | `f81f7f5e05` | 2.0.177+178 | 滑块 idle 36×4→active 48×12 形变+激活保持 3s 渐隐 |
| R2② 菜单退出双向动画 | `d78fa1edc5` | 2.0.178+179 | 顶/底栏常挂载+双向控制器（出 fadeOut140+scaleOut0.88@180） |
