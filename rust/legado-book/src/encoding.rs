...
//!
//! **计划偏差（F3-9，2026-08-14）**：REFACTORING 计划曾提及 chardetng；
//! 经评估，当前 BOM + 字节统计启发式（encoding_rs 解码校验）对 GBK/GB2312/UTF-8
//! 等中文阅读场景覆盖与 chardetng 等价，且零额外依赖；维持自研实现，不引入 chardetng。
//!
//! 处理流程：
