...
/// ViewPager 左右滑动 + BottomNavigationView 并存、双击回顶、返回键两段式）
void main() {
  ...
  testWidgets('初始结构：PageView + 底栏并存，书架为首页', (tester) async {
  ...
  testWidgets('左右滑动 PageView 切换到发现页，底栏选中态同步', (tester) async {
    await pumpHome(tester, MockRustApi());
